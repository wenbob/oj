...
- 考试答题页左侧显示题目列表和每题当前状态。
- 右侧显示当前题目详情、Monaco Editor、提交按钮和最近结果。
- 考试中切换题目时，右侧编辑器会加载当前题目的独立草稿和结果区域。
- 考试中提交成功后，左侧题目状态会刷新为当前最新评测状态。
...
```text
每道题取当前学生在本场考试中的最好提交结果。
如果某题有 Accepted，则获得该题满分。
否则该题 0 分。
题目满分来自 ExamProblem.score。
```
